...
// sets the icons to the actions/moves
...
// this function displays the player/computer score
...
// this function displays the move buttons for player selection
...
// ADD CODE THAT LIMITS THE GAME TO 3 ROUNDS THEN ASK IF PLAYER WANTS TO PLAY AGAIN. 
...
function App() {
  ...
  const onActionSelected = (selectedAction) => {
    const newComputerAction = Computer();
